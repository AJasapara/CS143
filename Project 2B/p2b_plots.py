...
plt.savefig("part2neg_map.png")

"""
PLOT 3: DIFFERENCE IN SENTIMENT BY STATE (%Positive - %Negative)
"""

diff_colors = {}
diff_cmap = plt.cm.Greens
